...
// หน้าจัดการแผนงบประมาณ — list / เพิ่ม / แก้ไข / ลบ
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      b.projectName ?? '(ไม่มีชื่อโครงการ)',
                      style: const TextStyle(
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    '${remaining.toStringAsFixed(2)} บาท',
                    style: TextStyle(
                  ...
                  Text(
                    'จาก ${allocated.toStringAsFixed(2)} บาท',
                    style: TextStyle(
...
class _BudgetFormDialogState extends State<_BudgetFormDialog> {
  ...
  void dispose() {
    for (final c in [
      _fiscalYear, _groupName, _projectName, _activityName,
      _egpNumber, _allocatedAmount, _responsiblePerson,
    ]) {
      c.dispose();
    }
    super.dispose();
  ...
  Future<void> _save() async {
    ...
    final b = Budget(
      ...
      activityName: _activityName.text.trim().isEmpty
          ? null
          : _activityName.text.trim(),
      egpNumber:
          _egpNumber.text.trim().isEmpty ? null : _egpNumber.text.trim(),
      allocatedAmount: allocated,
      // ถ้าแก้ไขของเดิม → คง remainingAmount ไว้ / ถ้าสร้างใหม่ → = allocatedAmount
        ...
        child: Form(
          ...
          child: SingleChildScrollView(
            child: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                _field(_fiscalYear, 'ปีงบประมาณ *', required: true,
                    hint: 'เช่น 2568'),
