...
const _monthlyRecurringTasks = [
  ...
  ProcurementCalendarTaskDef(
    slug: 'monthly_docs',
    title:
        'จัดทำใบเบิกพัสดุ / ใบรับพัสดุ / ใบส่งของ และสรุปรายงานพัสดุประจำเดือน',
  ),
];
...
final Map<int, List<ProcurementCalendarTaskDef>> _monthlyMilestoneTasks = {
  10: const [
    ProcurementCalendarTaskDef(
      slug: 'annual_plan',
      title:
          'จัดทำแผนพัสดุ/แผนจัดหาพัสดุประจำปี ภายใน 30 วันนับจากวันเริ่มปีงบประมาณ',
    ),
  ],
  12: const [
    ProcurementCalendarTaskDef(
        slug: 'q1_report', title: 'ส่งรายงานผลการจัดซื้อจัดจ้าง ไตรมาสที่ 1'),
  ],
  3: const [
    ProcurementCalendarTaskDef(
        slug: 'q2_report', title: 'ส่งรายงานผลการจัดซื้อจัดจ้าง ไตรมาสที่ 2'),
  ],
  6: const [
    ProcurementCalendarTaskDef(
        slug: 'q3_report', title: 'ส่งรายงานผลการจัดซื้อจัดจ้าง ไตรมาสที่ 3'),
  ],
  9: const [
    ProcurementCalendarTaskDef(
      slug: 'appoint_committee',
      title:
          'แต่งตั้งคณะกรรมการตรวจสอบพัสดุประจำปี และหัวหน้าเจ้าหน้าที่พัสดุสำหรับปีงบใหม่',
    ),
    ProcurementCalendarTaskDef(
      slug: 'annual_count',
      title:
          'ตรวจนับพัสดุประจำปี (ตรวจสอบครุภัณฑ์และวัสดุคงเหลือ) จัดทำแบบตรวจสอบครุภัณฑ์/รายงานพัสดุคงเหลือ',
    ),
    ProcurementCalendarTaskDef(
      slug: 'q4_report',
      title:
          'ส่งรายงานผลการจัดซื้อจัดจ้างประจำปี (รวมไตรมาส 4) ให้หน่วยงานกำกับ เช่น สตง./กรมบัญชีกลาง',
    ),
  ],
};
