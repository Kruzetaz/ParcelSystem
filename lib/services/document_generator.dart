...
class DocumentGenerator {
  ...
  static Map<String, bool> buildConditionalFlags(ProcurementOrder o) {
    ...
    return {
      ...
      // บรรทัดลงนาม inspector_2 / inspector_3 ในใบตรวจรับพัสดุ — โชว์เฉพาะเมื่อ
      // กรอกชื่อไว้จริง ทั้งกรณีคณะกรรมการที่มีครบ 2-3 คน และกรณีที่กรอกแค่บางคน
      // template ต้องครอบแต่ละบรรทัดด้วย {{if:has_inspector_2}}...{{endif:has_inspector_2}}
      'has_inspector_2': (o.inspector2?.trim().isNotEmpty ?? false),
      'has_inspector_3': (o.inspector3?.trim().isNotEmpty ?? false),
