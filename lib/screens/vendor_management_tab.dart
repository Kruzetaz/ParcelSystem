            ...
            child: Column(
              ...
              children: [
                ...
                _field(_addressNoCtrl, 'เลขที่ตั้ง/ที่อยู่',
                    ...
                    hint: 'เช่น 123 หมู่ 4 ถนนสุขุมวิท'),
                ...
                _field(_districtCtrl, 'อำเภอ/เขต',
                    fieldKey: 'address.district', hint: 'เช่น เมืองสุโขทัย'),
                _field(_provinceCtrl, 'จังหวัด',
                    fieldKey: 'address.province', hint: 'เช่น สุโขทัย'),
                _field(_postalCodeCtrl, 'รหัสไปรษณีย์', hint: 'เช่น 64000'),
                SwitchListTile(
