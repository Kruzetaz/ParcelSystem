...
class BrandColors {
  ...
  static const orange =
      Color(0xFFEA580C); // ใช้เฉพาะแถบกราฟงบตามฝ่าย (.brow) ลำดับที่ 3
...
class BrandAccent {
  ...
  static Color teal(BuildContext context) =>
      _isDark(context) ? const Color(0xFF2DD4BF) : BrandColors.teal;
  ...
  static Color tealOn(BuildContext context) =>
      _isDark(context) ? const Color(0xFF5EEAD4) : BrandColors.teal;
  static Color tealLight(BuildContext context) =>
      _isDark(context) ? const Color(0xFF5EEAD4) : BrandColors.tealLight;
  static Color tertiary(BuildContext context) =>
      _isDark(context) ? const Color(0xFFFBBF24) : BrandColors.tertiary;
  static Color green(BuildContext context) =>
      _isDark(context) ? const Color(0xFF4ADE80) : BrandColors.green;
  static Color red(BuildContext context) =>
      _isDark(context) ? const Color(0xFFF87171) : BrandColors.red;
  static Color indigo(BuildContext context) =>
      _isDark(context) ? const Color(0xFFA5B4FC) : BrandColors.indigo;
  static Color purple(BuildContext context) =>
      _isDark(context) ? const Color(0xFFD8B4FE) : BrandColors.purple;
  static Color blue(BuildContext context) =>
      _isDark(context) ? const Color(0xFF93C5FD) : BrandColors.blue;
  static Color navy(BuildContext context) =>
      _isDark(context) ? const Color(0xFF3B5FD4) : BrandColors.navy;
  static Color emerald(BuildContext context) =>
      _isDark(context) ? const Color(0xFF34D399) : BrandColors.emerald;
  ...
  static Color background(BuildContext context) =>
      _isDark(context) ? BrandColors.bgDark : BrandColors.background;
}
